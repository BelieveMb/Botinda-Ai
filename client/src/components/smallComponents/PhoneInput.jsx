  ...
  return (
    <div className="relative my-6">
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-2 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-blue-500 text-blue-800"
      />
    </div>
  );
};
